...
\section{Outside of the office I} 
\begin{itemize}
	\item Am an avid runner, having completed 3 full marathons and 8 half marathons.
	\item Teach programming at a local primary school on a voluntary basis (using Scratch and Python).
	\item Always have a personal programming or electronics project on the go, ask me about the latest!
\end{itemize}
